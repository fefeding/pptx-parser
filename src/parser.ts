...
let _processSingleSlideCallback: any = null;
let _processNodesInSlideCallback: any = null;
let _getBackgroundCallback: any = null;
let _getSlideBackgroundFillCallback: any = null;
/**
 * 配置解析器
 ...
 */
function indexNodes(content: any): any {
    ...
    if (processFullTheme === true) {
        ...
        if (bgNode) {
            ...
            if (bgPr) {
                ...
                if (solidFill) {
                    const color = (PPTXColorUtils as any).getFillColor(solidFill, warpObj.themeContent, warpObj.themeResObj, warpObj.slideLayoutClrOvride);
                    if (color) {
