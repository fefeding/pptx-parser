...
class TextUtils {
     ...
     */
    static getDingbatToUnicode(typefaceNode, buChar) {
        const dingbatCode = buChar.codePointAt(0) & 0xFFF;
        
        for (const item of dingbatUnicode) {
            if (item.f === typefaceNode && item.code === dingbatCode) {
                return item.unicode;
            }
        }
     ...
     */
    static getHtmlBullet(typefaceNode, buChar) {
        ...
        switch (buChar) {
            ...
            default:
                if (typefaceNode === "Wingdings" || typefaceNode === "Wingdings 2" || typefaceNode === "Wingdings 3") {
                    const wingCharCode = TextUtils.getDingbatToUnicode(typefaceNode, buChar);
