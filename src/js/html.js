...
let settings = {}; // 配置将由 configure 方法设置

// 图表 ID 计数器
let chartID = 0;
>>>>>>>> esmodule:src/js/html.js
...
>>>>>>>> esmodule:src/js/html.js
    ...
    function genTable(node, warpObj) {
        ...
        let tableHtml = `<table ${tblDir} style='border-collapse: collapse;${PPTXUtils.getPosition(xfrmNode, node, undefined, undefined)}${PPTXUtils.getSize(xfrmNode, undefined, undefined)} z-index: ${order};${tbl_borders};${tbl_bgcolor}'>`;
        ...
        for (let i = 0; i < trNodes.length; i++) {
            ...
            if (i == 0 && tblStylAttrObj["isFrstRowAttr"] == 1 && thisTblStyle !== undefined) {
                ...
                if (borderStyl !== undefined) {
                    const local_row_borders = PPTXUtils.getTableBorders(borderStyl, warpObj);
...
<<<<<<<< HEAD:src/js/html-generator.js
                    ...
                    var rowSpan = cellParmAry[3];
========
cellParmAry = PPTXTableUtils.getTableCellParams(tcNodes, getColsGrid, i, undefined, thisTblStyle, a_sorce, warpObj, styleTable);
text = cellParmAry[0];
colStyl = cellParmAry[1];
cssName = cellParmAry[2];
rowSpan = cellParmAry[3];
>>>>>>>> esmodule:src/js/html.js
...
>>>>>>>> esmodule:src/js/html.js
        ...
        const result = `<div id='chart${chartID}' class='block content' style='${
            PPTXUtils.getPosition(xfrmNode, node, undefined, undefined)}${PPTXUtils.getSize(xfrmNode, undefined, undefined)
        } z-index: ${order};'></div>`;
