/**
 * PPTX Action Button Shapes Utils
 * 生成操作按钮（actionButton）形状的 SVG 元素
 */
...
(function() {
    ...
    // 导出函数到全局对象
    if (!window.PPTXActionButtonShapes) {
        window.PPTXActionButtonShapes = {};
    }

    window.PPTXActionButtonShapes.genActionButtonBlank = function(w, h, imgFillFlg, grndFillFlg, shpId, fillColor, border) {
        return getActionButtonRect(w, h, imgFillFlg, grndFillFlg, shpId, fillColor, border);
    };
    window.PPTXActionButtonShapes.genActionButtonBackPrevious = genActionButtonBackPrevious;
    window.PPTXActionButtonShapes.genActionButtonBeginning = genActionButtonBeginning;
    window.PPTXActionButtonShapes.genActionButtonDocument = genActionButtonDocument;
    window.PPTXActionButtonShapes.genActionButtonEnd = genActionButtonEnd;
    window.PPTXActionButtonShapes.genActionButtonForwardNext = genActionButtonForwardNext;
    window.PPTXActionButtonShapes.genActionButtonHelp = genActionButtonHelp;
    window.PPTXActionButtonShapes.genActionButtonHome = genActionButtonHome;
    window.PPTXActionButtonShapes.genActionButtonInformation = genActionButtonInformation;
    window.PPTXActionButtonShapes.genActionButtonMovie = genActionButtonMovie;
    window.PPTXActionButtonShapes.genActionButtonReturn = genActionButtonReturn;
    window.PPTXActionButtonShapes.genActionButtonSound = genActionButtonSound;
