 ...
 */
(function(window) {
    if (!window.PPTXCalloutShapes) {
        window.PPTXCalloutShapes = {};

        // 楔形矩形标注
        window.PPTXCalloutShapes.genWedgeRectCallout = function(w, h, node, slideFactor) {
        ...
        // 楔形圆形标注
        window.PPTXCalloutShapes.genWedgeEllipseCallout = function(w, h, node, slideFactor) {
            var shapAdjst_ary = window.PPTXUtils.getTextByPathList(node, ["p:spPr", "a:prstGeom", "a:avLst", "a:gd"]);
            var refr = slideFactor;
            var sAdj1, adj1 = -20833 * refr;
            var sAdj2, adj2 = 62500 * refr;
        ...
        // 云形标注
        window.PPTXCalloutShapes.genCloudCallout = function(w, h, node, slideFactor) {
            var shapAdjst_ary = window.PPTXUtils.getTextByPathList(node, ["p:spPr", "a:prstGeom", "a:avLst", "a:gd"]);
            var refr = slideFactor;
            var sAdj1, adj1 = -20833 * refr;
            var sAdj2, adj2 = 62500 * refr;
        ...
        // 气泡标注
        window.PPTXCalloutShapes.genBorderCallout = function(w, h, node, slideFactor) {
            var shapAdjst_ary = window.PPTXUtils.getTextByPathList(node, ["p:spPr", "a:prstGeom", "a:avLst", "a:gd"]);
            var refr = slideFactor;
            var sAdj1, adj1 = -20833 * refr;
            var sAdj2, adj2 = 62500 * refr;
