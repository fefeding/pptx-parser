/**
 * 数学符号形状生成模块
 * 包含各种数学运算符号的 SVG 生成逻辑
 */
(function(window) {
    if (!window.PPTXMathShapes) {
        ...
        window.PPTXMathShapes.genMathPlus = function(w, h, node, slideFactor) {
            ...
            if (shapAdjst_ary !== undefined) {
                Object.keys(shapAdjst_ary).forEach(function (key) {
                    ...
                    if (name == "adj1") {
                        sAdj1 = window.PPTXUtils.getTextByPathList(shapAdjst_ary[key], ["attrs", "fmla"]);
            ...
            if (shapAdjst_ary !== undefined) {
                Object.keys(shapAdjst_ary).forEach(function (key) {
                    ...
                    if (name == "adj1") {
                        ...
                        sAdj2 = window.PPTXUtils.getTextByPathList(shapAdjst_ary[key], ["attrs", "fmla"]);
