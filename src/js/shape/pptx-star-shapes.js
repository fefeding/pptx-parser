 ...
 */
(function(window) {
    if (!window.PPTXStarShapes) {
        window.PPTXStarShapes = {};

        // 4角星
        window.PPTXStarShapes.genStar4 = function(w, h, node, slideFactor) {
        ...
        // 5角星
        window.PPTXStarShapes.genStar5 = function(w, h, node, slideFactor) {
        ...
        // 6角星
        window.PPTXStarShapes.genStar6 = function(w, h, node, slideFactor) {
        ...
        // 7角星
        window.PPTXStarShapes.genStar7 = function(w, h, node, slideFactor) {
            var hc = w / 2, vc = h / 2, wd2 = w / 2, hd2 = h / 2;
        ...
        // 8角星
        window.PPTXStarShapes.genStar8 = function(w, h, node, slideFactor) {
            var hc = w / 2, vc = h / 2, wd2 = w / 2, hd2 = h / 2;
            var adj = 12500 * slideFactor;
            var hf = 100000 * slideFactor;
        ...
        // 10角星
        window.PPTXStarShapes.genStar10 = function(w, h, node, slideFactor) {
            var hc = w / 2, vc = h / 2, wd2 = w / 2, hd2 = h / 2;
            var adj = 12500 * slideFactor;
            var hf = 105146 * slideFactor;
            var vf = 110557 * slideFactor;
        ...
        // 12角星
        window.PPTXStarShapes.genStar12 = function(w, h, node, slideFactor) {
            var hc = w / 2, vc = h / 2, wd2 = w / 2, hd2 = h / 2;
            var adj = 12500 * slideFactor;
            var hf = 100000 * slideFactor;
            var vf = 100000 * slideFactor;
        ...
        // 16角星
        window.PPTXStarShapes.genStar16 = function(w, h, node, slideFactor) {
            var hc = w / 2, vc = h / 2, wd2 = w / 2, hd2 = h / 2;
            var adj = 12500 * slideFactor;
            var hf = 100000 * slideFactor;
            var vf = 100000 * slideFactor;
        ...
        // 24角星
        window.PPTXStarShapes.genStar24 = function(w, h, node, slideFactor) {
            var hc = w / 2, vc = h / 2, wd2 = w / 2, hd2 = h / 2;
            var adj = 12500 * slideFactor;
            var hf = 100000 * slideFactor;
            var vf = 100000 * slideFactor;
        ...
        // 32角星
        window.PPTXStarShapes.genStar32 = function(w, h, node, slideFactor) {
            var hc = w / 2, vc = h / 2, wd2 = w / 2, hd2 = h / 2;
            var adj = 12500 * slideFactor;
            var hf = 100000 * slideFactor;
            var vf = 100000 * slideFactor;
