...
/** 默认边距（EMU） */
export const DEFAULT_MARGIN_EMU = 328600;

/** 标准高度（EMU） */
export const STANDARD_HEIGHT_EMU = 6858000;
...
/** PPTX百分比转换基数 */
export const PERCENTAGE_FACTOR = 100000;
...
/** 图表ID初始值 */
export const DEFAULT_CHART_ID = 0;
 ...
 * 
 * @typedef {Object} DingbatMapping
 * @property {string} f - 字体名称
 * @property {string} code - 字符代码
 * @property {string} unicode - Unicode码点
 */

/** @type {DingbatMapping[]} */
export const DINGBAT_UNICODE = [
    // Webdings
