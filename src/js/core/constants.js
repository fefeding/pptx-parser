...
export const slideFactor = 96 / 914400;

// 字体大小转换因子：将PT单位转换为PX单位
export const fontSizeFactor = 4 / 3.2;

// EMU 相关常量
export const EMU_PER_INCH = 914400;  // 1英寸的EMU单位数
export const DEFAULT_MARGIN_EMU = 328600;  // 默认边距（EMU）
export const STANDARD_HEIGHT_EMU = 6858000;  // 标准高度（EMU）

// 百分比和比例常量
export const PERCENTAGE_FACTOR = 100000;  // PPTX百分比转换基数

// 默认值常量
export const DEFAULT_RADIUS = 100;  // 默认多边形半径
export const DEFAULT_CHART_ID = 0;  // 图表ID初始值
export const DEFAULT_ORDER = 1;  // 顺序初始值
export const DPI = 96;  // 默认DPI值

// 右到左（RTL）语言代码数组
export const rtlLangsArray = ["he-IL", "ar-AE", "ar-SA", "dv-MV", "fa-IR", "ur-PK"];
/**
 * Dingbat 字体 Unicode 映射表
 * Webdings、Wingdings、Wingdings 2、Wingdings 3 字体的字符代码到 Unicode 的映射
 */
export const dingbatUnicode = [
