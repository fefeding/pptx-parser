/**
 * PPTX Parser - Color Utilities Module
 * 颜色处理工具模块 - 负责颜色相关的计算和转换
 */
(function () {
    'use strict';

    // Initialize PPTXColorUtils object if it doesn't exist
    if (!window.PPTXColorUtils) {
        window.PPTXColorUtils = {};
    }
    ...
    window.PPTXColorUtils.getGradientFill = getGradientFill;
    window.PPTXColorUtils.getPicFill = getPicFill;
    window.PPTXColorUtils.getPatternFill = getPatternFill;
    window.PPTXColorUtils.getLinerGrandient = getLinerGrandient;
    window.PPTXColorUtils.toHex = toHex;
    window.PPTXColorUtils.hslToRgb = hslToRgb;
